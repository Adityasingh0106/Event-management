...
const AddAvailability = () => {
  ...
  const fetchAvailability = async () => {
    try {
      ...
      const response = await axios.get("https://event-management-sw1u.onrender.com/api/auth/availability", {
        headers: {
          Authorization: token,
        },
      })
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        "https://event-management-sw1u.onrender.com/api/auth/availability",
